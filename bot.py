...
👑 VIP — 12.000 монет
   Эксклюзивная приписка и статус

🚀 Pro — 15.000 монет
   Профессиональный статус

🔥 Phoenix — 25.000 монет
   Уникальная огненная приписка
...
✨ У тебя есть следующие роли:
    ...
    # Просмотр роли в магазине
        ...
        if role == 'Vip':
            desc = "Эксклюзивная приписка и премиум статус"
        elif role == 'Pro':
            desc = "Профессиональный статус в чате"
        elif role == 'Phoenix':
            desc = "Уникальная огненная приписка"
        else:
            desc = "Легендарный статус и уважение"
