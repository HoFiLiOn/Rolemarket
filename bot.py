...
def handle_message(message):
    ...
    # Отправляем уведомление о начислении монеты (можно закомментировать, если спамит)
    # bot.send_message(user_id, f"✅ +1 монета! Всего: {get_user(user_id)['coins']}")
...
if __name__ == "__main__":
    ...
    print("✅ За каждое сообщение начисляется 1 монета")
